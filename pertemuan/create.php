        ...
        <div class="container">
            <form action="createp.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="pertemuanid" value="<?php echo $pertemuanid; ?>">
                    <input type="text" class="form-control" placeholder="Masukkan judul" id="judul" name="judul" required>
                </div>
                <div class="form-group">
                    <label for="isi">Keterangan:</label>
                    <textarea class="form-control" rows="5" id="isi" placeholder="Masukkan keterangan" name="isi" required></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check-inline">
                        ...
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="soal" value="y">Ya
                        </label>
                        </div>
                        <div class="form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="soal" value="n">Tidak
                        </label>
                    </div>
                </div>
                <div class="card" style="margin-bottom:20px;">
                    ...
                    <span style="color:red;">Jika materi ini pertanyaan, silahkan kosongkan bagian di bawah ini. Maksimal file yang dapat diupload adalah 41MB.</span>
                        ...
                        <input type="file" name="gambar" id="exampleInputFile" accept="image/*">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputFile">Video</label><br>
                        <input type="file" name="video" id="exampleInputFile" accept="video/*">
                        </div>
                    </div>
                </div>
