...
<body>
    ...
    <section class="pertemuanform">
        <div class="container">
            <form action="editkontrakp.php" method="POST" enctype="multipart/form-data">
                
                <div class="form-group">
                    <label for="kontrak">Kontrak Perkuliahan:</label>
                    <input type="hidden" name="crsid" value="<?php echo $crsid;?>">
                    <textarea class="form-control" rows="5" id="kontrak" placeholder="Kontrak Perkuliahan" name="kontrak" required><?php echo $data['kontrak_perkuliahan']; ?></textarea>
                </div>
