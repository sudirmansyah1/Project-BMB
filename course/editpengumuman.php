...
<body>
    ...
    <section class="pertemuanform">
        <div class="container">
            <form action="editpengumumanp.php" method="POST" enctype="multipart/form-data">
                
                <div class="form-group">
                    <label for="kontrak">Pengumuman Perkuliahan:</label>
                    <input type="hidden" name="crsid" value="<?php echo $crsid;?>">
                    <textarea class="form-control" rows="5" id="pengumuman" placeholder="Kontrak Perkuliahan" name="pengumuman_perkuliahan" required><?php echo $data['pengumuman_perkuliahan']; ?></textarea>
                </div>
