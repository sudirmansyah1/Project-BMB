        ...
        <div class="container">
            <form action="createp.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Tanggal/Bulan Awal - Tanggal/Bulan Akhir (Ex: 07/09 - 13/09)" id="waktu" name="waktu" required>
                </div>
                <div class="form-group">
                    <label for="judul">Judul Pertemuan:</label>
                    <input type="text" class="form-control" placeholder="Judul Pertemuan" id="judul" name="judul" required>
                </div>
                <div class="form-group">
                    <label for="pertemuan">Pertemuan Ke:</label>
                    <input type="number" min=1 max=999 class="form-control" id="pertemuan" name="pertemuan" required>
                </div>
