        ...
        <div class="container">
            <form action="editp.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" name="pertemuan" value="<?php echo $pertemuanid; ?>">
                    <input type="hidden" class="form-control" name="crsid" value="<?php echo $crsid; ?>">
                    <input type="text" class="form-control" placeholder="Tanggal/Bulan Awal - Tanggal/Bulan Akhir (Ex: 07/09 - 13/09)" value="<?php echo $datap['waktu']; ?>" id="waktu" name="waktu" required>
                </div>
                <div class="form-group">
                    <label for="judul">Judul Pertemuan:</label>
                    <input type="text" class="form-control" placeholder="Judul Pertemuan" id="judul" name="judul" value="<?php echo $datap['judul_pertemuan']; ?>" required>
                </div>
                <div class="form-group">
                    <label for="pertemuan">Pertemuan Ke:</label>
                    <input type="number" min=1 max=999 class="form-control" id="pertemuan" name="pertemuanke" value="<?php echo $datap['pertemuanke']; ?>" required>
                </div>
                
                
                <button type="submit" class="btn btn-primary">Submit</button> <a href="delete.php?id=<?php echo $pertemuanid;?>" class="btn btn-danger pull-right">Delete</a>
            </form>
        </div>
    </section>
    <!-- FOOTER -->
